...
if strAcao = "A" then
	conexao.begintrans
	strSql = "update [EVA].[dbo].[entidade] set (tipo_entidade_id="& intTipoEntidade &",nome='"& strNomeUsuario &"',email='"& strEmail &"',data_alteracao={ts '"& dtDataCadastro &"'}) where entidade_id = 
